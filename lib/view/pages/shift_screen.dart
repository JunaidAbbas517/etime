...
class _ShiftScreenState extends State<ShiftScreen> {
  ...
  Widget _buildShiftMarker(DateTime date) {
    List<Item> shifts = itemList.where((item) => isSameDay(item.date, date)).toList();
                          ...
                          onChanged: (int? newValue) {
                            if (newValue != null) {
                              setState(() {
                                ...
                                _onYearMonthChanged(DateTime(selectedYear, CustomDateUtils.monthNames.indexOf(selectedMonth) + 1, 1));
                              });
                            }
                          },
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      TableCalendar(
                  firstDay: DateTime(selectedYear, CustomDateUtils.monthNames.indexOf(selectedMonth) + 1, 1),
                  lastDay: DateTime(selectedYear, CustomDateUtils.monthNames.indexOf(selectedMonth) + 1, _getDaysInMonth(selectedYear, CustomDateUtils.monthNames.indexOf(selectedMonth) + 1)),
